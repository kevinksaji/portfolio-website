...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-background overflow-y-auto" style={{ 
      ...
      {/* Chat Section */}
      <section ref={chatSectionRef} className="min-h-screen w-full flex flex-col items-center justify-center px-4 bg-gradient-to-b from-background to-muted/20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="w-full max-w-2xl mx-auto">
            <ChatInput onSendAction={handleSearch} placeholder="Ask me anything about Kevin&apos;s..." />
          </div>
        </div>
      </section>
    </div>
